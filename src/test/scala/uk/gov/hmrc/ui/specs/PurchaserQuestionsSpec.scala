...
class PurchaserQuestionsSpec
  ...
  Feature("SDLT Filing Frontend Purchaser Questions") {
    Scenario(
      ...
      PurchaserAddPhoneNumberPage.verifyPageTitle(PurchaserAddPhoneNumberPage.pageTitle)
      When("the user selects the 'No' radio button")
      PurchaserAddPhoneNumberPage.radioButton(PurchaserAddPhoneNumberPage.no)
      And("clicks the Save and continue button")
      PurchaserAddPhoneNumberPage.saveAndContinue()
      Then("the user is navigated to the Does the Purchaser have a National Insurance number? page")
      PurchaserAddNINumberPage.verifyPageTitle(PurchaserAddNINumberPage.pageTitle)
      When("the user selects the 'Yes' radio button")
      PurchaserAddNINumberPage.radioButton(PurchaserAddNINumberPage.yes)
      And("clicks the Save and continue button")
      PurchaserAddNINumberPage.saveAndContinue()
    ...
    Scenario(
      ...
      PurchaserAddPhoneNumberPage.verifyPageTitle(PurchaserAddPhoneNumberPage.pageTitle)
      When("the user selects the 'Yes' radio button")
      PurchaserAddPhoneNumberPage.radioButton(PurchaserAddPhoneNumberPage.yes)
      And("clicks the Save and continue button")
      PurchaserAddPhoneNumberPage.saveAndContinue()
      ...
      PurchaserAddNINumberPage.verifyPageTitle(PurchaserAddNINumberPage.pageTitle)
      When("the user selects the 'No' radio button")
      PurchaserAddNINumberPage.radioButton(PurchaserAddNINumberPage.no)
      And("clicks the Save and continue button")
      PurchaserAddNINumberPage.saveAndContinue()
