...
object TaxCalculationsTotalPremiumValueFreeholdTaxCalulation extends BasePage {

  override def pageUrl: String = "tax-calculation/freehold-calculated/total-amount-due"
