...
object AddPurchaserAgentContactDetails extends BasePage {

  override def pageUrl: String = "about-the-purchasers-agent/add-agent-contact-details"

  override def pageTitle: String =
    s"Do you want to add contact details for the agent? - About the purchaser’s agent - Stamp Taxes Online - GOV.UK"
