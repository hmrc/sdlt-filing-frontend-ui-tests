...
object LandAddress extends BasePage {
  ...
  override def pageTitle: String =
    "Find the address of the land or property - About the land - Stamp Taxes Online - GOV.UK"

  val editPageTitle: String =
    "Enter the address of the land or property - About the land - Stamp Taxes Online - GOV.UK"

  val confirmPageTitle: String =
    "Review and confirm the address of the land or property - About the land - Stamp Taxes Online - GOV.UK"
